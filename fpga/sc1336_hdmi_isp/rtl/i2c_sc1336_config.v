...
always@(*)begin
        case(LUT_INDEX)
            ...
            // SC1336 exposure = {3e00[3:0], 3e01[7:0], 3e02[7:4]}, in half-line units.
            // 3e00 is left at reset default 0. Limit exposure to 0x0200 half-lines
            // (about 256 lines) to avoid low-light long-exposure frame lag.
            // Use gain / ISP brightness stages later for dark scenes.
            141:  LUT_DATA = {16'h3e01,8'h20}; // Exposure Time [15:8]
            142:  LUT_DATA = {16'h3e02,8'h00}; // Exposure Time [7:4]
            143:  LUT_DATA = {16'h3e08,8'h1f}; // Analog Gain Control, 1x
